...
# Date: March 25, 2025
# Description:
# This project implements a traditional credit scoring approach using a hybrid scorecard model.
# It integrates logistic regression, random forest, and neural network models,
